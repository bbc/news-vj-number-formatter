const NumberFormatter = require('../numberFormatter.node.js');
...
describe('Number formatter', function () {
    ...
    it('should format numbers using the BBC Bengali style', function () {
        expect(NumberFormatter.format('bengali', 14562.65)).toBe('১৪,৫৬২.৬৫');
        expect(NumberFormatter.format('bengali', 546)).toBe('৫৪৬');
        expect(NumberFormatter.format('bengali', 123456)).toBe('১২৩,৪৫৬');
        expect(NumberFormatter.format('bengali', 1.23)).toBe('১.২৩');
        expect(NumberFormatter.format('bengali', 1234567)).toBe('১,২৩৪,৫৬৭');
        expect(NumberFormatter.format('bengali', 100000000)).toBe('১০০,০০০,০০০');
    });
    ...
    it('should format numbers using the BBC Nepali style', function () {
        expect(NumberFormatter.format('nepali', 14562.65)).toBe('१४,५६२.६५');
        expect(NumberFormatter.format('nepali', 546)).toBe('५४६');
        expect(NumberFormatter.format('nepali', 123456)).toBe('१२३,४५६');
        expect(NumberFormatter.format('nepali', 1.23)).toBe('१.२३');
        expect(NumberFormatter.format('nepali', 1234567)).toBe('१,२३४,५६७');
        expect(NumberFormatter.format('nepali', 100000000)).toBe('१००,०००,०००');
    });
...
describe('Percentage formatter', function () {
    ...
    it('should append the percentage sign when the service requires', function () {
        ...
        expect(NumberFormatter.percentageFormat('bengali', 50)).toBe('৫০%');
